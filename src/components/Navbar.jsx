          ...
          <div className="px-4 pt-2 pb-6 space-y-1">
            {navLinks.map((link) => (
              <a
                ...
                className="block px-3 py-4 text-base font-medium text-zinc-600 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-500 hover:bg-zinc-50 dark:hover:bg-zinc-800 rounded-lg transition-all"
              >
                {link.name}
              </a>
            ))}
